        ...
        % for run_id = 1 : runs
            ...
            while nfes < max_nfes
                ...
                if(sum(Class_Select_Index)~=0)
                    ...
                    vi(Class_Select_Index,:) = pop(Class_Select_Index,:) + sf(Class_Select_Index, ones(1, problem_size)) .* (pbest(Class_Select_Index,:) - pop(Class_Select_Index,:) + pop(r11(Class_Select_Index), :) - popAll(r2(Class_Select_Index), :));
                end
